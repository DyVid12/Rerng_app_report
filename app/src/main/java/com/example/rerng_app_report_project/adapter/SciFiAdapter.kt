...
class SciFiAdapter: ListAdapter<Movy, SciFiAdapter.SciFiViewHolder>(SciFiDiffUtil) {
            ...
            if (!movy.poster.isNullOrEmpty()) {
                ...
                binding.image1.setOnClickListener { v ->
                    ...
                    val intent = Intent(context, MovieDetailActivity::class.java).apply {
                        ...
                        Log.d("SciFiAdapter ", "Passing Rating: $ratingValue")
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SciFiViewHolder {
        val binding = ViewHolderDataBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return SciFiViewHolder(binding)
    }
...
object SciFiDiffUtil: DiffUtil.ItemCallback<Movy>() {
