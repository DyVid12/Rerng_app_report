...
class FantasyAdapter : ListAdapter<Movy, FantasyAdapter.FantasyViewHolder>(FantasyDiffUtil) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FantasyViewHolder {
        val binding = ViewHolderDataBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return FantasyViewHolder(binding)
    }
...
object FantasyDiffUtil : DiffUtil.ItemCallback<Movy>() {
