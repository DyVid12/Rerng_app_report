...
class DramaAdapter : ListAdapter<Movy, DramaAdapter.DramaViewHolder>(DramaDiffUtil) {
            ...
            if (!movy.poster.isNullOrEmpty()) {
                ...
                binding.image1.setOnClickListener { v ->
                    ...
                    val intent = Intent(context, MovieDetailActivity::class.java).apply {
                        ...
                        Log.d("DramaAdapter ", "Passing Rating: $ratingValue")
...
object DramaDiffUtil : DiffUtil.ItemCallback<Movy>() {
