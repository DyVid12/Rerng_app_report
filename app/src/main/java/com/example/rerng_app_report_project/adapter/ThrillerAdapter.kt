...
class ThrillerAdapter: ListAdapter<Movy, ThrillerAdapter.ThrillerViewHolder>(ThrillerDiffUtil) {

    class ThrillerViewHolder(private val binding: ViewHolderDataBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bindThrillerDataMovie(movy: Movy) {
            if (!movy.poster.isNullOrEmpty()) {
                ...
                binding.image1.setOnClickListener { v ->
                    ...
                    val intent = Intent(context, MovieDetailActivity::class.java).apply {
                        ...
                        Log.d("ThrillerAdapter ", "Passing Rating: $ratingValue")
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ThrillerViewHolder {
        ...
        return ThrillerViewHolder(binding)
    }

    override fun onBindViewHolder(holder: ThrillerViewHolder, position: Int) {
        holder.bindThrillerDataMovie(getItem(position))
    }
}

object ThrillerDiffUtil: DiffUtil.ItemCallback<Movy>() {
