...
class WarAdapter : ListAdapter<Movy, WarAdapter.WarViewHolder>(WarDiffUtil) {

    class WarViewHolder(private val binding: ViewHolderDataBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bindWarDataMovie(movy: Movy) {
            if (!movy.poster.isNullOrEmpty()) {
                ...
                binding.image1.setOnClickListener { v ->
                    ...
                    val intent = Intent(context, MovieDetailActivity::class.java).apply {
                        ...
                        Log.d("WarAdapter ", "Passing Rating: $ratingValue")
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WarViewHolder {
        ...
        return WarViewHolder(binding)
    }

    override fun onBindViewHolder(holder: WarViewHolder, position: Int) {
        holder.bindWarDataMovie(getItem(position))
    }
}

object WarDiffUtil: DiffUtil.ItemCallback<Movy>() {
