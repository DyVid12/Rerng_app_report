            ...
            try {
                ...
                if (response.status == "success") {
                    ...
                    val filterData = response.movies?.filter { movie ->
                        movie.genres.any { genre -> genre.equals("Animation", ignoreCase = true) }
                    }
